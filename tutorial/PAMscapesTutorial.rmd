...
functions, users can load these as dataframes using the `checkSoundscapeInput` function.
...
pypam <- checkSoundscapeInput(here('tutorial/PyPamExample.nc'))
...
HMD values. The normalized ouput (red) closely tracks the original HMD output.
