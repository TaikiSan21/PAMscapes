...
```{r}
gps <- read_csv(here('testData/ADRIFT_017_GPS.csv'), show_col_types = FALSE)
ol <- read_csv(here('testData/ADRIFT_017_OL_mean_2min.csv'), show_col_types = FALSE)
bb <- read_csv(here('testData/ADRIFT_017_BB_mean_2min.csv'), show_col_types = FALSE)
...
that to show how the plotting function works.
