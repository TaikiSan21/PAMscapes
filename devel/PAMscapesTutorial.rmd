...
```{r}
gps <- read_csv(here('data/ADRIFT_017_GPS.csv'), show_col_types = FALSE)
ol <- read_csv(here('data/ADRIFT_017_OL_sim.csv'), show_col_types = FALSE)
bb <- read_csv(here('data/ADRIFT_017_BB_sim.csv'), show_col_types = FALSE)
...
```{r}
clicks <- readRDS(here('data/ADRIFT017_clicks.rds'))
